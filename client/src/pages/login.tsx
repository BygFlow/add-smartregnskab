...
const DEMO_USERS = [
 ...
 { email:"holdleder@addsmartregnskab.dk", role:"Holdleder" },
 { email:"assistent@addsmartregnskab.dk", role:"Assistent" },
 { email:"kunde@addsmartregnskab.dk", role:"Kunde" },
 { email:"leder2@addsmartregnskab.dk", role:"Leder (prøveperiode)" },
 { email:"leder3@addsmartregnskab.dk", role:"Leder (i restance)" },
];
...
export default function Login() {
 ...
 {notice ==="subscription" && <p>Kontakt ADD SmartRegnskab for at få hjælp til at genåbne adgangen.</p>}
 </div>
 </div>
 )}
 ...
 {/* Demo users — collapsible, discrete */}
 <details className="mt-4 rounded-lg bg-muted/50 border border-border group">
