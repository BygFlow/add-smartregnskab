...
import type { Company, Customer, Invoice, InvoiceItem } from "@shared/schema";
...
export function validateEInvoice(payload: string): string[] {
  ...
  for (const [pattern, message] of [
    [/<Invoice\b/, "Rod-elementet Invoice mangler."], [/<cbc:ID>[^<]+<\/cbc:ID>/, "Fakturanummer mangler."],
    ...
    [/<cac:InvoiceLine>/, "Mindst én fakturalinje kræves."], [/<cbc:PayableAmount\b/, "Betalingsbeløb mangler."],
