...
export default function Abonnement() {
  ...
  return (
    <div className="p-4 md:p-4 space-y-3 max-w-6xl mx-auto">
      ...
      <SectionCard data-testid="card-platform-invoices" title="Abonnementsfakturaer fra ADD SmartDrift Clean" icon={<Package className="w-4 h-4" />} className="space-y-3">
      ...
      <SectionCard className="flex gap-2 items-start">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          Der er ikke koblet en betalingsudbyder på. Abonnementsfakturaer udstedes af ADD SmartDrift Clean og markeres betalt manuelt.
