...
export async function platformInvoicePdf(
  ...
  doc.font("Helvetica").fontSize(9).fillColor(MUTED)
    .text("ADD SmartRegnskab ApS\nKøbenhavn\nCVR 00000000\nfaktura@addsmartregnskab.dk", L, 72, { lineGap: 1.5 });
  ...
  doc.font("Helvetica").fontSize(8.5).fillColor(MUTED)
    .text("Tak for samarbejdet. Spørgsmål til fakturaen sendes til faktura@addsmartregnskab.dk.",
      L, 762, { width: W, align: "center" });
