                  ...
                  <tr key={b.id} data-testid={`row-platform-backup-${b.id}`}>
                    ...
                    <td className="p-3 text-right">
                      {b.status === "fuldfort" || b.status === "fuldfoert" ? (
                        <button type="button" onClick={() => void openAuthedFile(`/api/platform/backups/${b.id}/download`, `platform-backup-${b.id}.zip`)} className="inline-flex items-center gap-1 text-xs text-primary hover:underline" data-testid={`button-download-platform-backup-${b.id}`}>
