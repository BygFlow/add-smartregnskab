...
/* Platform-sync — synkroniseringsjobs mellem ADD SmartDrift Clean og ADD SmartRegnskab */
...
const PLATFORM_LABEL: Record<string, string> = {
  smartdrift_clean: "ADD SmartDrift Clean",
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Synkroniseringsjobs mellem ADD SmartDrift Clean og ADD SmartRegnskab.
          </p>
        </div>
      ...
      <div className="flex items-start gap-2 rounded-md border border-blue-300/60 bg-blue-50 dark:bg-blue-950/20 p-3 text-sm text-blue-800 dark:text-blue-300">
        ...
        <span>Data flyder automatisk fra ADD SmartDrift Clean til ADD SmartRegnskab.</span>
      </div>
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="smartdrift_clean">ADD SmartDrift Clean</SelectItem>
