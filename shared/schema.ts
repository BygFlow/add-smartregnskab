...
export const plans = sqliteTable("plans", {
  ...
  maxDocuments: integer("max_documents").notNull().default(-1), // bilag er ubegrænsede
  ...
  maxIntegrations: integer("max_integrations").notNull().default(-1), // integrationer er ubegrænsede
