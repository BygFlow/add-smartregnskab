...
function StandaloneHeader() {
  return (
    <div className="flex items-center justify-between gap-3 flex-wrap py-2 border-b border-border">
      ...
      <StatusChip
        status="Forbundet til ADD SmartDrift Clean"
        variant="green"
    ...
    <SectionCard title="Regnskabsintegrationer" icon={<Plug className="w-4 h-4" />} noPadding>
      ...
      <div className="px-3 py-2 border-t border-border">
        <p className="text-xs text-muted-foreground">
          Integrationerne er mock — Forbind/Afbind skifter kun status lokalt. Reelle OAuth-forbindelser konfigureres via ADD SmartDrift Clean-platformen.
        </p>
      </div>
    </SectionCard>
  );
