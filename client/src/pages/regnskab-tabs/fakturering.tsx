                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-1">
                            ...
                            {inv.status === "sendt" && (
                              <Button
                                size="icon" variant="ghost"
                                onClick={() => void openAuthedFile(`/api/invoices/${inv.id}/pdf`, `faktura-${inv.invoiceNumber}.pdf`)}
  ...
  return (
    <Dialog open={!!invoice} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <DialogFooter>
          <Button variant="outline" onClick={() => void openAuthedFile(`/api/invoices/${invoice.id}/pdf`, `faktura-${invoice.invoiceNumber}.pdf`)}>
